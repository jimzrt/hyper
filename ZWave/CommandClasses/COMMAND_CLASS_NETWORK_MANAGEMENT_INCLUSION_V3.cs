...
{
    public class COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION_V3
    {
        ...
        public class NODE_ADD_STATUS
        {
            ...
            public static implicit operator NODE_ADD_STATUS(byte[] data)
            {
                ...
                if (data != null)
                {
                    ...
                    ret.seqNo = data.Length > index ? data[index++] : (byte)0x00;
                    ret.status = data.Length > index ? data[index++] : (byte)0x00;
                    ret.reserved1 = data.Length > index ? data[index++] : (byte)0x00;
        ...
        public class S2_ADVANCED_JOIN_MODE_GET
        {
            public const byte ID = 0x17;
            public byte seqNo;
            public static implicit operator S2_ADVANCED_JOIN_MODE_GET(byte[] data)
            {
                S2_ADVANCED_JOIN_MODE_GET ret = new S2_ADVANCED_JOIN_MODE_GET();
                if (data != null)
                {
                    int index = 2;
                    ret.seqNo = data.Length > index ? data[index++] : (byte)0x00;
            ...
            public static implicit operator byte[](S2_ADVANCED_JOIN_MODE_GET command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION_V3.ID);
                ret.Add(ID);
        ...
        public class SMART_START_JOIN_STARTED_REPORT
        {
        ...
        public class S2_ADVANCED_JOIN_MODE_SET
        {
            public const byte ID = 0x16;
            public byte seqNo;
            public byte s2AdvancedJoinMode;
            public static implicit operator S2_ADVANCED_JOIN_MODE_SET(byte[] data)
            {
                S2_ADVANCED_JOIN_MODE_SET ret = new S2_ADVANCED_JOIN_MODE_SET();
                if (data != null)
                {
                    int index = 2;
                    ret.seqNo = data.Length > index ? data[index++] : (byte)0x00;
                    ret.s2AdvancedJoinMode = data.Length > index ? data[index++] : (byte)0x00;
                }
                return ret;
            }
            public static implicit operator byte[](S2_ADVANCED_JOIN_MODE_SET command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION_V3.ID);
                ret.Add(ID);
                ret.Add(command.seqNo);
                ret.Add(command.s2AdvancedJoinMode);
                return ret.ToArray();
            }
        }
        public class S2_ADVANCED_JOIN_MODE_REPORT
        {
            public const byte ID = 0x18;
            public byte seqNo;
            public byte s2AdvancedJoinMode;
            public static implicit operator S2_ADVANCED_JOIN_MODE_REPORT(byte[] data)
            {
                S2_ADVANCED_JOIN_MODE_REPORT ret = new S2_ADVANCED_JOIN_MODE_REPORT();
                if (data != null)
                {
                    int index = 2;
                    ret.seqNo = data.Length > index ? data[index++] : (byte)0x00;
            ...
            public static implicit operator byte[](S2_ADVANCED_JOIN_MODE_REPORT command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION_V3.ID);
                ret.Add(ID);
        ...
        public class INCLUDED_NIF_REPORT
        {
