...
{
    public class COMMAND_CLASS_MULTI_CHANNEL_V4
    {
        ...
        public class MULTI_CHANNEL_AGGREGATED_MEMBERS_GET
        {
        ...
        public class MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT
        {
            ...
            public static implicit operator MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT(byte[] data)
            {
                ...
                if (data != null)
                {
                    ...
                    {
                        ret.aggregatedMembersBitMask.Add(data.Length > index ? data[index++] : (byte)0x00);
                    }
                }
                return ret;
            }
