...
{
    public class COMMAND_CLASS_ASSOCIATION_V2
    {
        ...
        public class ASSOCIATION_SPECIFIC_GROUP_GET
        {
        ...
        public class ASSOCIATION_SPECIFIC_GROUP_REPORT
        {
            ...
            public static implicit operator ASSOCIATION_SPECIFIC_GROUP_REPORT(byte[] data)
            {
                ...
                {
                    int index = 2;
                    ret.group = data.Length > index ? data[index++] : (byte)0x00;
                }
                return ret;
            }
